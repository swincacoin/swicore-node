...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    swid.spawn.datadir.should.equal(home + '/.swi');
    swid.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.swi/swid'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.swid.spawn.datadir.should.equal('./data2');
  });
});
