...
var swicorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = swicorenode.version;
  var create = swicorenode.scaffold.create;
  var add = swicorenode.scaffold.add;
  var start = swicorenode.scaffold.start;
  var remove = swicorenode.scaffold.remove;
  var callMethod = swicorenode.scaffold.callMethod;
  var findConfig = swicorenode.scaffold.findConfig;
  var defaultConfig = swicorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Swi database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Swicore Node configuration')
    .option('-d, --daemon', 'Make swicore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `swicore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ swicore-node add wallet-service');
      console.log('    $ swicore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ swicore-node remove wallet-service');
      console.log('    $ swicore-node remove insight-api');
      console.log();
    });
