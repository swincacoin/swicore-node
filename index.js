...
module.exports.services.Swi = require('./lib/services/swid');
...
module.exports.cli.swicore = require('./lib/cli/swicore');
module.exports.cli.swicored = require('./lib/cli/swicored');

module.exports.lib = require('@swincacoin/swicore-lib');
